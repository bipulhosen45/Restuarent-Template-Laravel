...
@section('admin_title', 'Edit | Topbar')
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h1 class="card-title">Edit Topbar</h1>
                    ...
                    <form action="{{route('topbar.update', $topbar->id)}}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{$topbar->name}}">
                            </div>
                            <div class="form-group">
                                <label for="icon">Navbar Icon</label>
                                <input type="text" class="form-control" name="icon" id="icon" value="{{$topbar->icon}}">
                            </div>
