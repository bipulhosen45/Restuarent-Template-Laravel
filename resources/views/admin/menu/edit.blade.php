                    ...
                    <form action="{{route('menu.update', $menu->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_title" id="sub_title" value="{{$menu->sub_title}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div><img src="{{asset('uploads/menu/'.$menu->image)}}" width="200" height="90" alt=""></div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('menu.index') }}" class="btn btn-warning float-right mx-2"><i
