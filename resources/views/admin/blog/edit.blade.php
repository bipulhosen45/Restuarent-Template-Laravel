                    ...
                    <form action="{{route('blog.update', $blog->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sub_title" id="sub_title" class="form-control" value="{{$blog->sub_title}}">
                            </div>
                            <div class="form-group">
                                <label for="date">Date</label>
                                <input type="text" name="date" id="date" class="form-control" value="{{$blog->date}}">
                            </div>
                            <div class="form-group">
                                <label for="image">File input</label>
                                <div><img src="{{asset('uploads/blog/'.$blog->image)}}" width="200" height="90" alt=""></div>
