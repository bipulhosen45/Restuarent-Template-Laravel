          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                {{-- <h1 class="card-title"><a href="{{ route('welcome.index')}}" class="btn btn-primary">All Welcomes</a></h1> --}}
              </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                         ...
                         <td>{{$welcome->link}}</td>
                         <td><img src="{{asset('uploads/welcome/'.$welcome->image)}}" width="200" height="70" alt=""></td>
                         <td>
                           <a href="{{route('welcome.show', $welcome->id)}}" class="btn btn-info"><i class="fas fa-eye"></i> </a>
                           <a href="{{route('welcome.edit', $welcome->id)}}" class="btn btn-warning my-1"><i class="fas fa-edit"></i> </a>
