      ...
      <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h1 class="card-title"><a href="{{ route('slider.index')}}" class="btn btn-outline-info">Back Slider Page</a></h1>
            ...
            <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" id="title" placeholder="Input your slider title">
                </div>
                <div class="form-group">
