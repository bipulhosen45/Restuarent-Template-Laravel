...
@section('admin_title', 'Edit |Special Item')
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h1 class="card-title">Edit Special Item</h1>
                    ...
                    <form action="{{route('product.update', $products->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_title" id="sub_title" value="{{$products->sub_title}}">
                            </div>
                            <div class="form-group">
                                <label for="image">File input</label>
                                <div><img src="{{asset('uploads/product/'.$products->image)}}" width="220" height="80" alt=""></div>
